...
function createWatcher(args, { state, rebuild }) {
    ...
    let pollInterval = 10;
    let watcher = chokidar_1.default.watch([], {
    ...
    function recordChangedFile(file, content = null, skipPendingCheck = false) {
        ...
        changedContent.push({
            file,
            content: content !== null && content !== void 0 ? content : (() => fs_1.default.promises.readFile(file, 'utf8')),
    ...
    watcher.on('unlink', (file) => {
        file = (0, normalize_path_1.default)(file);
        ...
        function enqueue() {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    let content = yield (0, utils_1.readFileWithRetries)(path_1.default.resolve(filePath));
                    ...
                    yield recordChangedFile(filePath, () => content, true);
                }
                catch (_a) {
